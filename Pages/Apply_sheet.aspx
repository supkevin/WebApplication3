<%@ Page Language="VB" AutoEventWireup="True" MaintainScrollPositionOnPostback="true"
    CodeFile="Apply_sheet.aspx.vb" Inherits="Pages_Apply_sheet" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        /* CSS */ .zipcode {
            ...
            margin: 2px;
            width: 80px; /*background-color: #c00;*/ /*color: #fff;*/
        }
        ...
        <form id="form1" runat="server">
            ...
            <div id="header1">
                <div id="fromtitle">
                    ...
                    <asp:Label ID="Lb_Apply_cate" runat="server" Text="" CssClass="title1"></asp:Label>
                </div>
            </div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="table1">
                        ...
                        <p style="color: Red; margin-left: 50px">
                            提醒您！有*符號為必填欄位，瀏覽器建議使用IE 8.0以上版本 最佳觀看解析度1024x768
                        </p>
                        <table>
                            <tr>
                                <td class="td1">*姓名：
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="Txt_Name" runat="server" CssClass="td2" Font-Size="Larger" placeholder="請輸入"
                                        MaxLength="20"></asp:TextBox>
                                    多次申請者，若曾更改姓名，請再填寫以下(改名前之姓名)欄位。
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">改名前之姓名：
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="Txt_OldName" runat="server" CssClass="td2" Font-Size="Larger" 
                                        MaxLength="20"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="Txt_Id" runat="server" CssClass="td2" Font-Size="Larger" placeholder="請輸入"
                            ...
                            <tr>
                                ...
                                <td class="td2">
                                    <asp:DropDownList ID="DpDownList_Year" runat="server" Font-Size="Large">
                                    </asp:DropDownList>
                                    年
                                <asp:DropDownList ID="DpDownList_Month" runat="server" Font-Size="Large">
                                </asp:DropDownList>
                                    月
                                <asp:DropDownList ID="DpDownList_Day" runat="server" Font-Size="Large">
                                </asp:DropDownList>
                                    日
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td2">
                                    <div id="txtCZipCode" style="font-size: larger">
                                    </div>
                                    <!--利用此隱藏欄位show錯誤訊息不可設為ReadOnly後端捉不到資料-->
                                    <asp:TextBox ID="TxtBox_Zid" runat="server" Font-Size="Larger" ReadOnly="false" Width="10px"
                                        Style="display: none"></asp:TextBox>
                                    <!--(start)jay(start)-->
                                    <div style="display: none">
                                        <asp:DropDownList ID="DpDownList_City" runat="server" Font-Size="Large" AutoPostBack="True"
                                            Width="100px">
                                        </asp:DropDownList>
                                        &nbsp;<asp:DropDownList ID="DpDownList_Downtown" runat="server" Font-Size="Large"
                            ...
                            <tr>
                                ...
                                <td class="td2">
                                    <!-- tc 記錄縣市用 -->
                                    <asp:TextBox ID="TxtBox_Address_Bak" runat="server" CssClass="td2" Font-Size="Larger"
                                        Width="60%" Style="display: none"></asp:TextBox>
                                    <asp:TextBox ID="TxtBox_Address" runat="server" CssClass="td2" Font-Size="Larger"
                                        Width="60%" MaxLength="100" placeholder="請填寫完整地址"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">*戶籍地址：
                                ...
                                <td class="td2">
                                    <asp:CheckBox ID="CkBox_RAddress" runat="server" Text="同聯絡地址" Font-Size="Larger"
                                        onclick="CheckAdd(this);" /><br />
                                    <div id="txtRZipCode" style="font-size: larger">
                                    </div>
                                    <!--利用此隱藏欄位show錯誤訊息不可設為ReadOnly後端捉不到資料-->
                                    <asp:TextBox ID="TxtBox_RZip" runat="server" Font-Size="Larger" ReadOnly="false"
                                        Width="60px" Style="display: none"></asp:TextBox>
                                    <!--(start)jay(start)-->
                                    <div style="display: none">
                                        <asp:DropDownList ID="DpDownList_RCity" runat="server" Font-Size="Large" AutoPostBack="True"
                                            Width="100px">
                                        </asp:DropDownList>
                                        &nbsp;<asp:DropDownList ID="DpDownList_RDowntown" runat="server" Font-Size="Large"
                                            AutoPostBack="True" Width="100px">
                                        </asp:DropDownList>
                                    </div>
                                    <!--(end)jay(end)-->
                            ...
                            <tr>
                                ...
                                <td class="td2">
                                    <div id="SameAddress">
                                        <!-- tc 記錄縣市用 -->
                                        <asp:TextBox ID="TxtBox_RAddress_Bak" runat="server" CssClass="td2" Font-Size="Larger"
                                            Width="60%" Style="display: none"></asp:TextBox>
                                        <asp:TextBox ID="TxtBox_RAddress" runat="server" CssClass="td2" Font-Size="Larger"
                                            Width="60%" MaxLength="100" placeholder="請填寫完整地址"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_Tel_1" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="20"
                                        placeholder="範例：07-5587166"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">*電話(夜)：
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_Tel_2" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="20"
                                        placeholder="範例：07-5587166"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_Mobile" runat="server" CssClass="td2" Font-Size="Larger"
                                        MaxLength="15" placeholder="範例：0955-888999"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">*電子郵件信箱：
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_Email" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="50"
                                        Width="70%" placeholder="請輸入"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <table id="Table_Damage" class="tb1" runat="server">
                                        <tr>
                                            <td class="td1">*損傷類別：
                                            </td>
                                            <td class="td2">
                                                <asp:RadioButtonList ID="RdButton_Damage" runat="server" RepeatDirection="Vertical"
                                                    ...
                                                    <asp:ListItem Value="F5">顏面損傷5.皮膚病變(含魚鱗癬症、胎記、太田母斑)</asp:ListItem>
                                                    <asp:ListItem Value="F6">顏面損傷6.其他</asp:ListItem>
                                                </asp:RadioButtonList>
                                                <asp:TextBox ID="TxtBox_Damage" runat="server" CssClass="td2" Font-Size="Larger"
                                                    MaxLength="20"></asp:TextBox>
                                                <br />
                <asp:Label ID="lblTrauma_Old" runat="server" Text="lblTrauma_Old" Visible="False" ForeColor="Red" ></asp:Label>
                            ...
                            <tr>
                                <td class="td1">
                                    <!-- here tc -->
                                    *<span class="bolder">現在</span>就讀(畢)學校：
                                </td>
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_School" runat="server" CssClass="td2" Font-Size="Larger"
                                        MaxLength="50" placeholder="請輸入"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">科系名稱：
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_Dep" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="50"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">*年級：
                                ...
                                <td class="td2">
                                    <asp:TextBox ID="TxtBox_Grage" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="1"
                                        placeholder="請輸入"></asp:TextBox>請輸入阿拉伯數字
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">*申請次數：
                            ...
                            <tr id="apply_groups" runat="server">
                                ...
                                <td class="td2">
                                    <asp:DropDownList ID="DpDownList_Awards" runat="server" Font-Size="Large">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table id="Table_Apply_Item_S" class="tb1" runat="server">
                                        <tr>
                                            <td class="td1">*申請獎項：
                                            </td>
                                            <td class="td2">
                        ...
                        <a href="#" class="jastips">(一)特殊才藝優秀獎學金
                        <span>
                        申請條件：<br />
                        ...
                        <a href="#" class="jastips">(五)勇源-陽光子女助學金    
                        <span>
                        申請條件：<br />
                        顏損或遭重大燒傷之子女，於<br />
                        ...
                        <a href="#" class="jastips">(六)明閱科技-陽光子女特殊才藝獎學金
                        <span>
                        申請條件：<br />
                        ...
                        (1)博士班  一萬元整 (2)碩士班  一萬元整(3)大專  一萬元整(4)高中(職)  陸仟元整(5)國中  參仟伍佰元整(6)國小  貳仟元整
                                                ...
                                                <div id="ShowParent" runat="server">
                                                    ...
                                                    <asp:Label ID="Label1" runat="server" Text="*子女助學金之損傷者姓名"></asp:Label><asp:TextBox
                                                        ID="TxtBox_PName" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="20"
                                                        placeholder="請輸入父(母)姓名"></asp:TextBox><br />
                                                </div>
                                                <!--parent-->
                                            </td>
                                        </tr>
                                    </table>
                                    <table id="Table_Apply_Item_Z" class="tb1" runat="server">
                                        <tr>
                                            <td class="td1">*申請獎項：
                                            </td>
                                            <td class="td2">
                        ...
                        *TQC檢定為企業人才技能認證，是財團法人中華民國電腦技能基金會針對企業用才需求，所提出來的一項整合性認證。故此檢定之通過「非」本獎項之獎助範疇<br />
                        ...
                        電腦優秀獎助學金及電腦傑出才藝獎合計共錄取十位，以未請領陽光基金會當年度其他獎助學金者為優先，每名獎助金額為壹萬元。
                                    ...
                                    <table id="Table_Apply_Item_M" class="tb1" runat="server">
                                        <tr>
                                            <td class="td1">*申請獎項：
                                            </td>
                                            <td class="td2">
                                                ...
                                                <asp:Label ID="Label10" runat="server" Text="子女助學金之損傷者姓名"></asp:Label><asp:TextBox
                                                    ID="TxtBox_PName_M" runat="server" CssClass="td2" Font-Size="Larger" MaxLength="20"></asp:TextBox><br />
                            ...
                            <tr>
                                ...
                                <td class="td2">
                                    <asp:RadioButtonList ID="RdButton_Mode" runat="server" RepeatDirection="Vertical"
                                    ...
                                    <div id="recommend">
                                        <div style="margin-bottom: 5px; margin-left: 15px">
                                            <asp:Label ID="Label3" runat="server" Text="*推薦單位：" CssClass="td2"></asp:Label><asp:TextBox
                                                ID="TxtBox_Recommend" runat="server" Font-Size="Larger" MaxLength="50" CssClass="td2"
                                                placeholder="請輸入"></asp:TextBox>
                                        </div>
                                        <div style="margin-bottom: 5px">
                                            <asp:Label ID="Label4" runat="server" Text="*推薦人姓名：" CssClass="td2"></asp:Label><asp:TextBox
                                                ID="TxtBox_Rec_Name" runat="server" Font-Size="Larger" MaxLength="20" CssClass="td2"
                                                placeholder="請輸入"></asp:TextBox>
                                        </div>
                                        <div style="margin-bottom: 5px">
                                            <asp:Label ID="Label5" runat="server" Text="*推薦人職務：" CssClass="td2"></asp:Label><asp:TextBox
                                                ID="TxtBox_Rec_Position" runat="server" Font-Size="Larger" MaxLength="20" CssClass="td2"
                                                placeholder="請輸入"></asp:TextBox>
                                        </div>
                                        <div style="margin-bottom: 5px">
                                            <asp:Label ID="Label6" runat="server" Text="*推薦人電話：" CssClass="td2"></asp:Label><asp:TextBox
                                                ID="TxtBox_Rec_Tel" runat="server" Font-Size="Larger" MaxLength="20" CssClass="td2"
                                                placeholder="請輸入"></asp:TextBox>
                                        </div>
                                    </div>
                                    <!--推薦人-->
                            ...
                            <tr>
                                <td class="td1_1">*獎金匯款銀行帳戶：
                                </td>
                                <td class="td2_1">
                                    <div style="margin-bottom: 5px; margin-left: 35px">
                                        <asp:Label ID="Label7" runat="server" Text="戶名：" CssClass="td2"></asp:Label><asp:TextBox
                                            ID="TxtBox_Account_Name" runat="server" Font-Size="Larger" MaxLength="20" CssClass="td2"
                                            placeholder="限本人"></asp:TextBox>
                                    </div>
                                    <div style="margin-bottom: 5px; display: none">
                                        <asp:Label ID="Label8" runat="server" Text="銀行代碼：" CssClass="td2"></asp:Label>
                                        <asp:DropDownList ID="DpDownList_Bank_Code" runat="server" Font-Size="Large" AutoPostBack="True"
                                            onchange="ShowProgressBar();">
                                        </asp:DropDownList>
                                    </div>
                                    <div style="margin-bottom: 5px; display: none">
                                        <asp:Label ID="Label12" runat="server" Text="分行代碼：" CssClass="td2"></asp:Label>
                                        <asp:DropDownList ID="DpDownList_Bank_Name" runat="server" Font-Size="Large" onchange="WriteBankCode();">
                                        </asp:DropDownList>
                                    </div>
                                    <!--(bank)Jay(bank)-->
                                    <div style="display: inline; width: 100%">
                                        <asp:Label ID="Label13" runat="server" Text="銀行代碼：" CssClass="td2" Style="display: none"></asp:Label>
                                        <div id="txtBank" style="font-size: larger; display: inline"></div>
                                        <asp:TextBox runat="server" Font-Size="Larger" CssClass="td2"
                                            ID="TxtBox_Bank" Width="90px" Style="display: none" disabled="disabled"></asp:TextBox>
                                    </div>
                                    <!--(bank)Jay(bank)-->

                                    <div style="margin-bottom: 5px">
                                        <asp:Label ID="Label9" runat="server" Text="銀行帳戶：" CssClass="td2"></asp:Label><asp:TextBox
                                            ID="TxtBox_Account_No" runat="server" Font-Size="Larger" MaxLength="20" CssClass="td2"
                                            placeholder="請輸入"></asp:TextBox>
                                        <span>(請只輸入數字,郵局請填局號+帳號共14碼)</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="td2">
                                    <table class="tb2">
                                        <tr>
                                            <td >
                                                <asp:TextBox ID="TxtBox_VerifyCode" runat="server" CssClass="td2" Font-Size="Larger"
                                                    MaxLength="5" placeholder="請輸入"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Image ID="imgCode" runat="server" ImageUrl="BuildVerifyChart.aspx" onclick="ChgCode();"
                                                    CssClass="imgCode" Height="34px" Width="91px" />
                                            </td>
                                            <td>
                                                <input type="button" class="Btn1" value="重新產生" onclick="ChgCode();" title="重新產生" />
                                                <asp:Button ID="btnChangeCode" runat="server" Text="重新產生" CssClass="Btn" OnClientClick="ShowProgressBar();"
                                                    Visible="false" />
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <br />
                        <center>
                            <asp:Button ID="btn1" runat="server" Text="測試資料(陽光)" Visible="false" />
                            <asp:Button ID="btn2" runat="server" Text="測試資料(仁寶)" Visible="false" />
                            ...
                            <asp:Button ID="Btn_Ok" runat="server" Text="送出資料" CssClass="Btn" OnClientClick="return ShowModalPopup();" /></center>
                        <center>
                        ...
                        <asp:Panel ID="PnlApplyOk" runat="server" CssClass="modalPopup_Apply" Style="display: none; background-color: White">
                            <div class="header">
                                申請成功提示
                            </div>
